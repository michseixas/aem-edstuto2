...
## Environments
- Preview: https://main--aem-edstuto2--michseixas.hlx.page/
- Live: https://main--aem-edstuto2--michseixas.hlx.live/
...
1. Open the `aem-edstuto2` directory in your favorite IDE and start coding :)
